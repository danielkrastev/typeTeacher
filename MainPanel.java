...
public class MainPanel extends JFrame {
	...
	static final String WELCOMEMESSAGE = "Добре дошли! Първото, което трябва да направите във всяко ниво, е да изградите рефлекса на пръстите си! Не бързайте! Преди да измервате времето си направете упражнението без грешка!";
